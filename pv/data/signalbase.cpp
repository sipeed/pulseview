...
// Default signal colors come from the theme's high-distinction trace
// palette, designed for dark canvas backgrounds.
...
const QColor SignalBase::LogicSignalColors[10] =
{
	...
	QColor(0x4D, 0xB6, 0xAC),	// Teal
	QColor(0xFF, 0x8A, 0x65),	// Deep Orange
	QColor(0x9A, 0xA1, 0xAD),	// Grey
	QColor(0xE4, 0xE7, 0xEC),	// White
};
